...
setup:function(){
	...
	b+="</div>"),
	b+='<div id="quiz-controls1">',
	b+='<p id="quiz-response"></p>',
	b+='<div id="quiz-buttons">',
	b+='<div align="center"><a href="#" id="quiz-next-btn">Next</a></div>',
	b+='<div align="center"><a href="#" id="quiz-finish-btn">Finish</a></div>',
	b+='<div align="center"><a href="#" id="quiz-restart-btn">Restart</a></div>',
	b+="</div>",
	b+="</div>",
...
answerQuestion:function(b){
	if(!o){
		o=!0;
		var c=a(b),d="",g=c.data("index"),h=m-1,i=f[h].correctIndex;
		if(g===i)
		    c.addClass("correct"),d=f[h].correctResponse,n++;
...
finish:function(){
	...
	a("#quiz-restart-btn").show(),a(k).show(),
...
restart:function(){
	...
	a("#quiz-start-screen").show().addClass("active-question"),
	e.methods.updateCounter()},
    reset:function(){o=!1,m=1,n=0,
...
home:function(){
	...
	a(h).show(),"function"==typeof e.options.homeCallback&&e.options.homeCallback()
},
updateCounter:function(){
		var b=e.options.counterFormat.replace("%current",m).replace("%total",g);a("#quiz-counter").html(b)
}},
